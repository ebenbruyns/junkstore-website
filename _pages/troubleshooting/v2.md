---
layout: splash
title: "Junk Store Pro Troubleshooting"
description: "Fix Junk Store Pro issues for Epic, GOG, Amazon & itch games on Steam Deck. Complete troubleshooting guide for standalone app installation, compatibility, and launch problems."
...
<div class="faq-search-container">
  ...
  <div class="search-results-info" id="search-info">Showing all 10 troubleshooting questions</div>
</div>
...
<details class="faq-box" id="installation-not-completing">
  <summary>Junk Store Pro installation fails</summary>
...
<details class="faq-box" id="sd-card-permissions-error">
  ...
  <p></p>
    If you're getting permissions errors when trying to install games to your SD card, you need to properly configure your install location in Junk Store Pro.
  <br><br>
    ...
    if (query === '') {
      ...
      faqItems.forEach(item => {
        ...
        if (summaryText.includes(query) || contentText.includes(query)) {
          ...
          // Highlight matches - preserve anchor buttons
