...
description: "Step-by-step setup tutorials for Junk Store on Steam Deck — Decky Plugin install, Pro install, GOG Extension setup, OAuth login, Proton versions, frame generation, language settings, Ubisoft games, and more."
