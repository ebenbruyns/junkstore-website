...
<div class="js-media-grid">
  <div class="js-media-card">
    <a href="https://youtu.be/iRVFqHGkqio?si=H3RnIVYtWN6vxsaC" target="_blank" rel="noopener noreferrer">
      <img src="https://img.youtube.com/vi/iRVFqHGkqio/hqdefault.jpg" alt="Interview with Gardiner Bryant (Video)" loading="lazy" width="320" height="180" class="js-media-card__image">
    </a>
    <p class="js-media-card__title">Interview with Gardiner Bryant - June 2025</p>
    <p class="js-media-card__caption">Click to watch on YouTube</p>
  </div>
