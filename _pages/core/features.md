...
<div class="media-grid">
  ...
  <!-- Placeholder for video reviews - add more here -->
  <div class="media-item coming-soon">
    <p class="caption-title">More reviews coming soon</p>
    <p class="caption">Check back for additional video reviews and guides.</p>
  </div>
...
<div class="media-grid">
  ...
  <!-- Placeholder for articles - add more here -->
  <div class="media-item coming-soon">
    <p class="caption-title">More articles coming soon</p>
    <p class="caption">Check back for additional written coverage and guides.</p>
  </div>
...
.differentiator-item .problem {
  color: #ff6b6b;
  margin-bottom: 0.5rem;
  font-size: 0.9rem;
}

.differentiator-item .solution {
  color: #4caf50;
  margin-bottom: 0;
  font-size: 0.9rem;
}
