...
<section class="tutorial-section">
  ...
  <ul>
    ...
    <img src="/assets/images/gogext/extracthere.png" alt="Extract here" width="600" />
    <li>Double-click the extracted file to launch the installer</li>
    <img src="/assets/images/gogext/launchinstaller.png" alt="Launch Installer" width="600" />
    <li>Follow the prompt to install the GOG extension</li>
    <img src="/assets/images/gogext/installerprompt.png" alt="Click yes to run installer" width="600" />
  </ul>
  ...
  <ul>
    ...
    <img src="/assets/images/gogext/installdeps.png" alt="Install dependencies in Junk Store" width="600" />
  </ul>
  ...
  <ul>
    ...
    <img src="/assets/images/gogext/jstabs.png" alt="Gog tab visible in Junk Store" width="600" />
  </ul>
